...
CREATE TABLE `otp_verification` (
  ...
  PRIMARY KEY (`id`),
  KEY `userId` (`userId`),
  CONSTRAINT `otp_verification_ibfk_1` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'minh','do','0906359977','23880043@student.hcmus.edu.vn','$2a$10$66jGNbdhdD4GjjEGlm.OCuY/uIzpQhsGH.WerpgKqQ7ddeJnDTHSG','donor',0,'2024-10-03 14:34:59','2024-10-03 14:34:59','NOT_NEEDED'),(2,'string','string','090909999','string','$2a$10$fW/bXqrdmvLTZrjPUC9X1uoZErvQE.3VXOWOqWvCVk5HSW7XJHhA6','admin',0,'2024-10-05 07:27:35','2024-10-05 07:27:35','NOT_NEEDED');
...
-- Dump completed on 2024-10-08 19:05:59
